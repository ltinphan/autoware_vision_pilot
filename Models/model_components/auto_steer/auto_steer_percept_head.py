...
class AutoSteerPerceptHead(nn.Module):
    def __init__(self, nc, in_ch):
        ...
        self.c1 = Conv(in_ch2, 2, torch.nn.SiLU(), k=3, s=1, p=1)
        self.c2 = Conv(in_ch2, 2, torch.nn.SiLU(), k=3, s=1, p=1)
        ...
        self.h1 = nn.Conv2d(2, 2, kernel_size=(1, 16), stride=(1, 16))
        self.h2 = nn.Conv2d(2, 2, kernel_size=(1, 16), stride=(1, 16))
    ...
    def forward(self, x):
        ...
        row_multiplier = row_multiplier.view(1, 1, 1, W).expand(B, 2, 1, W)
